...
export default class Bount extends React.Component {
    constructor(props) {
        super(props)
        this.state = {
            questions: [],
    ...
    componentDidMount() {
        axios.get("https://api.stackexchange.com/2.2/questions/featured?order=asc&sort=activity&site=stackoverflow")
            .then((response) => {
